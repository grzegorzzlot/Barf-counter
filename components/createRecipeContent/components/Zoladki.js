...
import {getZoladki} from '../../../actions/index.js';

class Zoladki extends Component {
    state = {
...
const mapDispatchToProps = {getZoladki}
...
export default connect(null, mapDispatchToProps)(Zoladki);