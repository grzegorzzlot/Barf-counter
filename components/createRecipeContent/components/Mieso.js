...
import {getMieso} from '../../../actions/index.js';
    ...
    render() {
        ...
        return(
            <View style={styles.container}>
                <Text text='Mieso' fontFamily='product-sans-bold'/>
...
const mapDispatchToProps = {getMieso}
...
export default connect(null, mapDispatchToProps)(Mieso);