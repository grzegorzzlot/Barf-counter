...
import {getSerca} from '../../../actions/index.js'; 

class Serca extends Component {
    state = {
...
const mapDispatchToProps = {getSerca}
...
export default connect(null, mapDispatchToProps)(Serca);